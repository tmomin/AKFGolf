                            ...
                            <div class="datepicker-calendar">
                                <div class="datepicker-calendar-header">
                                    <button type="button" class="prev"><span
                                                class="glyphicon glyphicon-chevron-left"></span><span class="sr-only">Previous Month</span>
                                    </button>
                                    <button type="button" class="next"><span
                                                class="glyphicon glyphicon-chevron-right"></span><span class="sr-only">Next Month</span>
                                    </button>
              ...
              <span class="month">
                ...
                <span data-month="11">December</span>
                                ...
                                <table class="datepicker-calendar-days">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td class="last-month past restricted" data-date="29" data-month="2"
                                            data-year="2015" title="Restricted"><span><b class="datepicker-date">29</b></span>
                                        </td>
                                        <td class="last-month past restricted" data-date="30" data-month="2"
                                            data-year="2015" title="Restricted"><span><b class="datepicker-date">30</b></span>
                                        </td>
                                        <td class="last-month past restricted" data-date="31" data-month="2"
                                            data-year="2015" title="Restricted"><span><b class="datepicker-date">31</b></span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td data-date="24" data-month="3" data-year="2015" class="current-day"><span><button
                                                        type="button" class="datepicker-date">24</button></span></td>
                                        <td data-date="25" data-month="3" data-year="2015"><span><button type="button"
                                                                                                         class="datepicker-date">25</button></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td data-date="26" data-month="3" data-year="2015"><span><button type="button"
                                                                                                         class="datepicker-date">26</button></span>
                                        </td>
                                        <td data-date="27" data-month="3" data-year="2015"><span><button type="button"
                                                                                                         class="datepicker-date">27</button></span>
                                        </td>
                                        <td data-date="28" data-month="3" data-year="2015"><span><button type="button"
                                                                                                         class="datepicker-date">28</button></span>
                                        </td>
                                        <td data-date="29" data-month="3" data-year="2015"><span><button type="button"
                                                                                                         class="datepicker-date">29</button></span>
                                        </td>
                                        <td data-date="30" data-month="3" data-year="2015"><span><button type="button"
                                                                                                         class="datepicker-date">30</button></span>
                                        </td>
                                        ...
                                        <td class="next-month" data-date="2" data-month="4" data-year="2015"><span><button
                                                        type="button" class="datepicker-date">2</button></span></td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="datepicker-wheels" aria-hidden="true">
                                ...
                                <div class="datepicker-wheels-footer clearfix">
                                    <button type="button" class="btn datepicker-wheels-back"><span
                                                class="glyphicon glyphicon-arrow-left"></span><span class="sr-only">Return to Calendar</span>
                                    </button>
